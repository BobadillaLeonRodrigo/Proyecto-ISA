                ...
                <div class="container">
                    <div class="py-2 text-warning">
                        <form class="row g-2 border border-warning border-3 rounded-top"
                            action="{{ route('salvarTC', ['id' => $tipocita->ID_TipoCitas]) }}" method="post"
                            enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="col-sm-6 offset-sm-3 text-center">
                                <label for="inputEmail4" class="form-label">Nombre del Role</label>
                                <input value="{{ $tipocita->Descripcion }}" type="text" class="form-control"
                                    name="Descripcion">
                            </div>
                            <div class="col-sm-12 py-2">
                                <button type="submit" class="btn btn-success">Editar Tipo de Cita</button>
                            </div>
                        </form>
                    </div>
                </div>
