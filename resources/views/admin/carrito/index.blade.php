        ...
        <div class="row">
            <main class="col-md-10 ms-sm-auto col-lg-12 px-md-4">
                ...
                <div class="py-2 text-warning">
                    <form class="row g-2 border border-warning border-3 rounded-top" action="{{route('agregar')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="col-sm-4 text-center">
                            ...
                            <input type="email" class="form-control" id="inputAddress" placeholder="example@gmail.com" name="Email">
                        </div>
                        <div class="col-sm-4 text-center">
