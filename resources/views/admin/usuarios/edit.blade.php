                ...
                <div class="container">
                    <div class="py-2 text-warning">
                        <form class="row g-2 border border-warning border-3 rounded-top"
                            action="{{ route('salvar', ['id' => $usuario->ID_Usuario]) }}" method="post"
                            enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="col-sm-4 text-center">
                                <label for="inputEmail4" class="form-label">Nombre</label>
                                <input value="{{ $usuario->Nombre_Usuario }}" type="text" class="form-control"
                                    name="Nombre_Usuario">
                            </div>
                            <div class="col-sm-4 text-center">
                                <label for="inputPassword4" class="form-label">Apellido Paterno</label>
                                <input value="{{ $usuario->Apellido_Paterno }}" type="text" class="form-control"
                                    id="inputPassword4" name="Apellido_Paterno">
                            </div>
                            <div class="col-sm-4 text-center">
                                <label for="inputPassword4" class="form-label">Apellido Materno</label>
                                <input value="{{ $usuario->Apellido_Materno }}" type="text" class="form-control"
                                    id="inputPassword4" name="Apellido_Materno">
                            </div>
                            <div class="col-sm-4 text-center">
                            ...
                            <div class="col-sm-4 text-center">
                                ...
                                <input value="{{ $usuario->Contraseña }}" type="password" class="form-control"
                                    id="inputAddress2" name="Contraseña">
                            </div>
